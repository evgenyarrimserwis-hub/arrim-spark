...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ARIMSERWIS — Serwis sprzętu stomatologicznego Warszawa" },
      ...
      { name: "author", content: "ARIMSERWIS" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          email: "arimserwis@gmail.com",
          taxID: "PL5291833249",
          vatID: "PL5291833249",
          areaServed: ["Warszawa", "Pruszków", "Piastów", "Ożarów Mazowiecki", "Grodzisk Mazowiecki", "Żyrardów"],
          address: { "@type": "PostalAddress", streetAddress: "ul. H. Szczerkowskiego 4", postalCode: "05-827", addressLocality: "Grodzisk Mazowiecki", addressCountry: "PL" },
